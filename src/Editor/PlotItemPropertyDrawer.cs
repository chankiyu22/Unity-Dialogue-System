...
class PlotItemPropertyDrawer : PropertyDrawer
{
    public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
    {
        ...
        Rect avatarTexturePropRect = new Rect(position.x, position.yMax - EditorGUIUtility.singleLineHeight * 2 - 6, 70, EditorGUIUtility.singleLineHeight);
        ...
        EditorGUI.DrawRect(avatarTexturePropRect, Color.red);
